...
\cvname{Naeimeh \newline Mahmoudian} % Your name
\cvjobtitle{Infra Engineer} % Job title/career

\cvdate{May 1993} % Date of birth
\cvaddress{Tehran,IR} % Short address/location, use \newline if more than 1 line is required
\cvnumberphone{+98 930 9078792} % Phone number
\cvsite{https://naei.me} % Personal website
\cvmail{naeimeh@naei.me} % Email address
...
\skills{{pursuer of rabbits/5.8},{good manners/4},{outgoing/4.3},{polite/4},{Python/0.01}}
...
\begin{twenty} % Environment for a list with descriptions
	\twentyitem{2019-Now}{Dev Ops Engering }{tapsi.ir}{Maintain and develop }
	\twentyitem{2017-2019}{Software Engeer}{iais.ir}{I was in }
	\twentyitem{2016-2016}{Disney Film.}{iseema.ir}{Walt Disney brings Lewis Carroll's fantasy story to life in this well done animated classic. Even though many elements from the book were dropped, such as the duchess with the baby pig and mock turtle, this version is without a doubt the most famous Alice adaption made.}
	%\twentyitem{<dates>}{<title>}{<location>}{<description>}
\end{twenty}
